...
- Une catégorie de mouvement sur écran
- Une catégorie de capteurs
Nous avons decidé de les developper en flutter.
...
-Ces différents jeux devraient pouvoir être jouer en mode solo et en mode duo, 
- ajouter de la Musique pendant et à la fin de chaque manche
- faire 2 jeux par catégorie
- afficher le score après chaque manche
- Ajouter un mode d'entrainement

Nous avons utilisé comme librairies:
- la librairie sensors_Plus pour les jeux de capteurs
- librairie flutter_p2p_connection pour le mode duo (nous avons reussi à connecter deux téléphones et s'envoyer des messges)
- librairie audio_players pour la musique
